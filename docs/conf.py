...
# -*- coding: utf-8 -*-
#
# pydcop documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'pydcop.tex', 'pydcop Documentation',
     'Pierre Rust', 'manual'),
]
...
man_pages = [
    (master_doc, 'pydcop', 'pydcop Documentation',
     [author], 1)
]
